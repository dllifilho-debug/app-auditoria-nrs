...
- **`contradiz` derruba**: vira veto, a constatação vai aos pontos de atenção com "verificar no
  ...
  uma frase declarando a retirada).
...
MESMA imagem. Se perguntado de frente ele repetir a leitura errada, a rede não pega nada. Sete
testes travam o mecanismo (falham no código antigo); nenhum teste alcança o comportamento do
...
$VENV -m pytest tests/ -q          # 301 testes
