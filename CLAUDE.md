...
- **"Área de corte sem barreira de acesso" não tem item alcançável — medido em 11/09, com
  ...
  **e também disparou `area_de_risco_nao_delimitada`** (NR-16 16.8, explosivos/inflamáveis),
  ...
  deles ainda pela armadilha dos 4+ radicais. **Consertado**: os quatro sinais reescritos para
  sempre exigir o objeto (`tanque`/`tancagem`/`radioativa`) como radical obrigatório, em sinais
  de 3 radicais — onde 2 de 3 falha o corte de 0,7 e o domínio não pode ser o que falta. De
  quebra, `"radioativa sem isolamento"` cobre a classe que a descrição do risco já prometia
